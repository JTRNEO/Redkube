...
DATASETS = {
    ...
    'ships_train': {
        IM_DIR:
            _DATA_DIR + '/ships/images/train',
        ANN_FN:
            _DATA_DIR + '/ships/annotations/instances_train.json'
    },
    'ships_val': {
        IM_DIR:
            _DATA_DIR + '/ships/images/val',
        ANN_FN:
            _DATA_DIR + '/ships/annotations/instances_val.json'
    },


    'iiai_train': {
        IM_DIR:
            _DATA_DIR + '/iiai/images/train',
        ANN_FN:
            _DATA_DIR + '/iiai/annotations/instances_train.json'
    },
    'iiai_val': {
        IM_DIR:
            _DATA_DIR + '/iiai/images/val',
        ANN_FN:
            _DATA_DIR + '/iiai/annotations/instances_val.json'
    },


    'abu_musa_train': {
        IM_DIR:
            _DATA_DIR + '/abu_musa/images/train',
        ANN_FN:
            _DATA_DIR + '/abu_musa/annotations/instances_train.json'
    },
    'abu_musa_val': {
        IM_DIR:
            _DATA_DIR + '/abu_musa/images/val',
        ANN_FN:
            _DATA_DIR + '/abu_musa/annotations/instances_val.json'
    },
