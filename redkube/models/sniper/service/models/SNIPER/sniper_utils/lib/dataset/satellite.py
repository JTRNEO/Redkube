...
class Satellite(IMDB):
    def __init__(self, image_set, root_path, data_path, result_path=None, mask_size=-1, binary_thresh=None,
        ...
        :param data_path: 'data/satellite'
        """
        super(Satellite, self).__init__('Satellite', image_set, root_path, data_path, result_path)
    ...
    # TODO: rewrite the funciton
    def image_path_from_index(self, index):
        """ example: images / train2014 / COCO_train2014_000000119993.jpg """
        # filename = 'COCO_%s_%012d.jpg' % (self.data_name, index)
        # pdb.set_trace()
        # self.coco.imgs['file_name']
        image_path = os.path.join(self.data_path, 'images', self.data_name, self.coco.imgs[index]['file_name'])
