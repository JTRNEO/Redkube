...
class resnet_mx_101_e2e_mask_satellite(Symbol):
    ...
    def get_mask_head(self, feat, num_layers=4, num_classes=18):
        mask_relu_out = feat
    ...
    def get_symbol_rcnn(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            # Put the Mask head
            mask_pred = self.get_mask_head(mask_deformable_roi_pool, num_classes=18)

            # Compute the mask targets
            # TODO: check num_classes, ajust the default setting
            # TODO: check the hard code, choose right param ofr num_proposals
